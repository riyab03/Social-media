...
module.exports.getNotifications=async(req,res,next)=>{
  ...
  data=await Promise.all(data.map(async(item)=>{
    ...
    return {isgrpinvite:true,grpdetails:{_id:grp._id,name:grp.name,profileImage:grp.profileImage?grp.profileImage:null},_id:item._id,senderdetails:{_id:user._id,username:user.username,profileImage:user.profileImage?`http://localhost:5000/uploads/${user.profileImage}`:null}};
  }));
