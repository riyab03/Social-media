...
//-----------------------------------------------------------------------------------------------
   ...
   const movetomessage=(msgid,yes)=>{
    ...
    setTimeout(()=>{
      if(yes)
      document.getElementById(`${msgid}`).style.background=' #e0c3ff';
      else
  ...
  return (
    <div className="chat-container">
      ...
      <ArrowLeftOutlinedIcon onClick={handlebackinmobile}/>
            ...
            <div ref={scrollRef}  key={uuidv4()}>
              ...
              >
                 {message.replyfor&&
                  ...
                  <span className='replymsg-sender' style={{color:'purple',fontWeight:'600'}}>{message.replyfor.senderid===currUserDetails._id?"You":message.replyfor.sender}</span>
