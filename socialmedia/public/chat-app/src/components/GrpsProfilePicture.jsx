...
function GrpsProfilePicture({item,style,showusername}) {
    ...
    const imgstyle2={
        width:'50px',height:'50px',borderRadius:'50%',cursor:'pointer',bgcolor:purple[500]
    }
    const imgstyle1={
        width:'42px',height:'42px',borderRadius:'50%',cursor:'pointer',bgcolor:purple[500],border:'2px solid white',boxSizing:'border-box'
    }
