              ...
              return (
                ...
                >
                  ...
                  <div style={{fontSize:'0.7rem',color:'gray',position:'absolute',right:'15px'}}>
                    ...
                    <br/>{( unseenmsglist[contact._id]!==undefined && unseenmsglist[contact._id]!==0) && <span style={{background:'purple',borderRadius:'50%',color:'white',width:'20px',height:'20px',display:'flex',justifyContent:'center',alignItems:'center'}}>{unseenmsglist[contact._id]}</span>}
                    </div>
                    </div>
                </div>
              );
