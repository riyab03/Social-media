...
import ShowWholeProfile from './ShowWholeProfile';
...
export default function ProfileViewer({open,setOpen,id}) {
  ...
  const [showwholeprofile,setshowwholeprofile]=React.useState(false);
  React.useEffect(()=>{
  ...
  const imgstyle1={
    width:'250px',height:'250px',borderRadius:'50%',bgcolor: purple[500]
  }
  const imgstyle2={
    width:'400px',height:'400px',borderRadius:'50%',bgcolor: purple[500]
  }
  const handleClose = () => {
    setOpen(false);
...
{         loading?
        (
          ...
          <Button onClick={handleClickOpen}>View Profile</Button>
          <ShowWholeProfile setOpen={setshowwholeprofile} open={showwholeprofile} id={id}></ShowWholeProfile>
          </Typography>
          </>
}
        </DialogContent>
