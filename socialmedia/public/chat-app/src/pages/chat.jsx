  ...
  return (
    <>
        ...
        <div className="container">
          ...
          {!currentChat && !currentgrpchat&&<Contacts  contacts={contacts} changeChat={handleChatChange} changegroupchat={changegroupchat} unseenmsglist={unseenmsglist}/>}
          {(currentChat||currentgrpchat)&&
          <div id='chatsformobile'>
          {currentChat&&<ChatContainer currentChat={currentChat} setCurrentChat={setCurrentChat}socket={socket} contacts={contacts} updatecontacts={updatecontacts} setunseenmsglist={setunseenmsglist}/>}
           { currentgrpchat&&<Groupchatcontainer currentgrpchat={currentgrpchat} setCurrentgrpchat={setCurrentgrpchat}socket={socket} contacts={contacts} updatecontacts={updatecontacts}  setunseenmsglist={setunseenmsglist} ></Groupchatcontainer>}
          </div>
}
